    ...
    },
    {
        ...
        "cities": [
            ...
            },
            {
                ...
                "country_label": "Netherlands",
                "status": "Visited",
                "intro": "Recommendations from a friend who knows the city well. Rotterdam has a very different feel from Amsterdam, much more modern architecture and a lot going on.",
                "tips": [
                    {"label": "Getting around", "text": "A walk along the canals is always a good idea. The whole Kralingen area is beautiful with a large park, lake and forest. People swim in the lake when the weather is good.", "neutral": True},
                ],
                "places": [
                    {"name": "Kralingen Lake", "desc": "A large park, lake and bit of forest on the east side of the city. Beautiful area even if you just walk around. People swim in the lake in summer. <a href='https://www.google.com/maps/place/Kralingen+Lake/@51.9346221,4.5043208,15z' target='_blank' rel='noopener'>Map</a>"},
                    {"name": "Climbing Park Fun Forest", "desc": "An adventure park, good for children. The whole surrounding area is worth visiting even if you skip the park itself. <a href='https://www.google.com/maps/place/Climbing+Park+Fun+Forest+Rotterdam/@51.9280456,4.5002781,14.54z' target='_blank' rel='noopener'>Map</a>"},
                    {"name": "Kijk-Kubus (Cube Houses)", "desc": "The famous cubic houses. People live in them and you can visit one inside. Recommended if you have children. Next to them is the Market Hall which is a cool building in its own right. There is a place at the entrance that sells good stroopwaffles. In the whole area you may find a food market with fresh fish, vegetables, fruit and lots of flowers."},
                    {"name": "Market Hall", "desc": "Impressive covered market hall right next to the Cube Houses. Good architecture and food. <a href='https://www.google.com/maps/place/Market+Hall,+Verlengde+Nieuwstraat,+3011+GX+Rotterdam' target='_blank' rel='noopener'>Map</a>"},
                    {"name": "Miniworld Rotterdam", "desc": "A miniature world museum. Popular with children. <a href='https://www.google.com/maps/place/Miniworld+Rotterdam/@51.9190638,4.4802305,14.54z' target='_blank' rel='noopener'>Map</a>"},
                    {"name": "Maritime Museum", "desc": "All my friend's male friends loved this. They have lots of different games you can play, good for kids too. <a href='https://www.google.com/maps/place/Maritime+Museum/@51.9175644,4.4796514,17z' target='_blank' rel='noopener'>Map</a>"},
